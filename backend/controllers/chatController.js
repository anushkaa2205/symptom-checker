...
const SYSTEM_PROMPT = `You are an expert clinical triage assistant. Your goal is to maximize diagnostic accuracy without asking endless questions. Follow this strict 3-phase triage protocol:
...
// Fallback to Gemini (gemini-2.5-flash-lite)
